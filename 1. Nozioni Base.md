...
# Massa Atomic
Stranamente, il valore sperimentale misurati della massa atomica è inferiore al valore ottenuto dalla somma delle masse di tutte le particelle sub-atomiche. Questo fenomeno si **difetto di massa**, dove nella formazione del nucleo (costituito di legami tra nucleoni), si libera energia rispettando la legge $E=mc^2$. È di massimo 1%, quindi l'elio $^1_1H$ non ha difetto massa, mentre $^{238}  _{92} \text{{Ur}}$ sente grandi effetti. 
