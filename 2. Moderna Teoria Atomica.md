...
2. Tutte le energia sono negative, l'elettrone possiede minore energia il più vicino è al nucleo.
3. All'aumentare di n, energia diventano meno negative
...
Quando n=1 si dice che è uno stato fondamentale, mentre per n>1 sidice che lo stato è eccitato. 
## Orbitali
...
$$
P(r) = r^2R^2(r)
$$e rappresenta la probabilità che un elettrone sia trovabile in un guscio sottile di raggio r e spessore $\delta r$. 
![[orbitali.jpg]]
...
Tuttavia questo non vale nel caso del Chromo, che ha orbitali 3d e 4s che si trovano ad energie molto simili. Per questo, invece di riempire prima tutto il 4s$^2$ 3d$^4$, si arriva alla configurazione 4s$^1$ 3d$^5$
