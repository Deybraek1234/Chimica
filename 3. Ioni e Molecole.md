...
Lo stato di ossidazione è il numero di elettroni che l’atomo cederebbe o guadagnerebbe quando forma un legame chimico. Si possono prevedere sulla base della configurazione elettronica dell'elemento neutro. Sono generalmente pochi per ogni elemento chimico (guarda file Latex per esempio). 
...
Regole importanti 
	...
	3. Per soddisfare regola dell'ottetto, l'ossigeno tende a formare sempre due legami
		...
		2. Con i perossidi, fatto tra 2 atomi di O legati fra di loro e legati ad altri elementi meno elettronegativi, il legame che lega i due ossigeni sarà pari $\rightarrow$ l'ossigeno avrà numero di ossidazione -1
