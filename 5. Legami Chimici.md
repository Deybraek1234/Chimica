...
Ci sono altre molecole (cicliche) che non possono stare planari come il cicloesano. Per esempio c'è la conformazione sedia e la conformazione barca. Nella conformazion esedia, gli atomi di carbonio sono leggermente sfasati dal piano centrale, e gli angoli sono circa di 109$^{\degree}$. Se no esiste quella a barca che è abbastanza instabile. La configurazione a sedia è la più favorita. 

Per spiegazione glucosio guarda lezione 4 Novembre prima parte. 5