...
Se consideriamo Z contro l'energia, l'energia decresce con più che Z cresce per l'effetto scherma. Questo vuol dire che fino all'azoto, gli orbitali si rimescolano (s-p mixing) e quindi abbiamo che l'orbitale $\sigma_{2p}$ ha più energia degli orbitali $\pi_{2p}$. Questo succede solo per molecole leggere. 