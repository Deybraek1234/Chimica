...
Questo modello si rappresenta in questo modo 
![[lewis2.png]]
...
## Legame Dativo
Secondo Lewis esiste il legame dativo o legame coordinato. È un invenzione, dove per formare un legame, entrambi gli elettroni vengono dati da un solo atomo come nel caso dell'ione ammonio 
![[ioneammonio.png]]
...
Tutte le coppie attorno un atomo centrale vengono chiamate coppie strutturali. Le coppie strutturali sono quelle che determinano la geometria attorno l'atomo centrale. La geometria della molecola viene rappresentata in questo modo 
![[VESPR.png]]
...
Per l'ione NO$_3$ abbiamo che per la VSEPR
ne$^-$ = 5(N) + 3 $\cdot$ 2 (o,$\sigma$) - 3 $\cdot$ 2 (o, $\pi$) + 1(carica) $\rightarrow$ 6 elettroni $\rightarrow$ 3 C.S.
Uno degli ossigeni si prende l'elettrone e quindi avrà potrà crearsi solo un legame singolo perché avrà solo un elettrone libero. Il N invece, diventa un N$^+$ e il terzo ossigeno diventa O$^-$ così può formare 3 legami $\sigma$ previsti dalla geometria AX$_{3}$ e un legame $\pi$ tra NO. Quindi lo ione lo posso descrivere come N$^+$ legato ad un doppio con un O e 2 O$^-$ ma questi si possono alternare tra tutti e tre gli ossigeni, quindi ho 3 forme di risonanza. Posso descrivere questo come tutti gli atomi che hanno un legame, più un'altro che non c'è interamente. L'ordine sarà di più di un legame singolo, ma di meno di un legame doppio. 

Usando la teoria studiata prima, possiamo studiare le basi del DNA. Prima abbiamo sempre considerato solo un atomo centrale con altri atomi legati, ma questo è un modello limitato. Quando ci sono più centri, si possono comunque usare i modelli studiati prima, individuando uno scheletro centrale e applicando VSEPR ad ogni atomo di questo scheletro, considerando ogni atomo come atomo centrale. 
![[dna.png]]
Prendiamo le basi DNA come esempio. Tutte queste molecole sono planari. 

Ci sono altre molecole (cicliche) che non possono stare planari come il cicloesano. Per esempio c'è la conformazione sedia e la conformazione barca. Nella conformazione sedia, gli atomi di carbonio sono leggermente sfasati dal piano centrale, e gli angoli sono circa di 109$^{\degree}$. Se no esiste quella a barca che è abbastanza instabile. La configurazione a sedia è la più favorita. 

Per spiegazione glucosio guarda lezione 4 Novembre prima parte. Quando il carbonio porta 4 sostituenti, orbitale sp$^3$ ha una proprietà che si chiama chiralità, dove i legami sono specchiati, e tutte le proprietà sono uguali. È una proprietà fondamentale nella chimica biologica. Questa proprietà si può spiegare attraverso le mani. Entrambi le cose si chiamano enantiomeri e una delle classi più importanti di questi sono gli amino acidi. Sullo stesso gruppo carbonio portano un gruppo ammonio e COOH (acido). Sull'altro carbonio è attaccato un gruppo H e un reagente, tutti gli amino acidi hanno questa disposizione degli sostituenti. esistono 20 standard che differiscono per il tipo di catena laterale
...
Le molecole paramagnetiche contengono elettroni non appaiati e sono attratti ad un campo magnetico.  oa
...
## N = 2
Gli orbitali P hanno 3 orientazioni diversi nello spazio. Per la formazione di un legame sappiamo che la simmetria è importante. 
![[orbitalimolecolarip.png]]
...
## S-P Mixing
Se consideriamo Z contro l'energia, l'energia decresce con più che Z cresce per l'effetto scherma. Questo vuol dire che fino all'azoto, gli orbitali si rimescolano (s-p mixing) e quindi abbiamo che l'orbitale $\sigma_{2p}$ ha più energia degli orbitali $\pi_{2p}$. Questo succede solo per molecole leggere. Alcune volte l'ordine di legame può aumentare o diminuire se si guadagna un elettrone. Se l'energia di legame diminuisce, vuol dire che l'ordine di legame è diminuito. Come si può vedere 
![[bond_order.png]]
fino all'ossigeno, gli orbitali $\pi$ hanno più energia degli orbitali $\sigma$. In questo caso la funzione d'onda $\sigma_{s}$ si combina con $\sigma_{p}$ e il primo orbitale diventa più stabile (meno energia), mentre il secondo diventa meno stabile. Questo succede perché gli orbitali s e p hanno energie simili, fino all'ossigeno, dove la differenza diventa troppo grande. 

## Molecole eteronucleari
Lo schema è analogo a quello delle molecole omonucleari, ma non è simmetrico. HOMO (Highest Occupied Molecular Orbital) LUMO (Lowest Unoccupied Molecular Orbital), se si individua entrambi di questi legami si può spiegare tutta la chimica della molecola. 
